...
namespace deCONZ
{
    ...
    */
    ...
    QDataStream &DECONZ_DLLSPEC operator<<(QDataStream &ds, ZclDataTypeId_t id);
 ...
 */
     ...
     */
    QDataStream & DECONZ_DLLSPEC operator<<(QDataStream &ds, ZclCommandId_t id);
...
*/
     ...
     */
    QDataStream & DECONZ_DLLSPEC operator<<(QDataStream &ds, ZclAttributeId_t id);
 ...
 */
     ...
     */
    QDataStream & DECONZ_DLLSPEC operator<<(QDataStream &ds, ManufacturerCode_t mfcode);
 ...
 */
     ...
     */
    QDataStream & DECONZ_DLLSPEC operator<<(QDataStream &ds, ZclClusterId_t id);
